...
const ProductList = ({ onClick }: Props) => {
  ...
  const getProducts = useSelector((state) =>
    getVisibleProduct(
      state.customizer.ecommerceReducer.products,
      state.customizer.ecommerceReducer.sortBy,
      state.customizer.ecommerceReducer.filters,
      state.customizer.ecommerceReducer.productSearch
    )
  );
