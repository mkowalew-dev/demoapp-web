...
const ProductFilter = () => {
  ...
  const products = useSelector((state) => state.customizer.ecommerceReducer.products);
  const active = useSelector((state) => state.customizer.ecommerceReducer.filters);
  const checkactive = useSelector((state) => state.customizer.ecommerceReducer.sortBy);
