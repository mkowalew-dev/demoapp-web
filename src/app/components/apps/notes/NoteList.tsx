...
const NoteList = () => {
  ...
  const activeNote = useSelector((state) => state.customizer.notesReducer.notesContent);
  const searchTerm = useSelector((state) => state.customizer.notesReducer.noteSearch);
  ...
  const notes = useSelector((state) =>
    filterNotes(state.customizer.notesReducer.notes, state.customizer.notesReducer.noteSearch)
  );
  console.log(notes)
  return (
    <>
